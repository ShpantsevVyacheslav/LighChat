...
/// (без завершающего `/`). Если не задано — используется основной прод-домен (должен совпадать
/// с BotFather `/setdomain` и с тем, что в Firebase Hosting).
String telegramAuthBridgePageUrl() {
  ...
  return 'https://lighchat.online/auth/telegram?mobile=1';
}
