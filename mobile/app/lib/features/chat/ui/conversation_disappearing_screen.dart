...
List<({String label, int? ttlSec})> _disappearingPresets(
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      body: SafeArea(
        child: Column(
          children: [
            ChatProfileSubpageHeader(title: l10n.disappearing_messages_title),
            Expanded(
              child: StreamBuilder<DocumentSnapshot<Map<String, dynamic>>>(
                ...
                builder: (context, snap) {
                  ...
                  final summary = formatDisappearingTtlSummaryForLocale(
                    l10n,
                    current,
                  );
                  return ListView(
