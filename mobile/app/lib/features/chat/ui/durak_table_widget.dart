...
class DurakTableWidget extends StatelessWidget {
  ...
  final GlobalKey Function(int attackIndex, {required bool defense}) pairKeyForFlight;
  ...
  final bool Function(Map<String, dynamic> card, int attackIndex) canAcceptDefense;
  final Future<void> Function(int attackIndex, Map<String, dynamic> card) onDefenseDropped;
              ...
              children: [
                for (final p in pairs)
                  _DurakTablePair(
                    ...
                    suitLabel: suitLabel,
                    isRedSuit: isRedSuit,
                    attackKeyForFlight: pairKeyForFlight(p.index, defense: false),
                    defenseKeyForFlight: pairKeyForFlight(p.index, defense: true),
                  ),
                _NextAttackSlot(keyForFlight: nextAttackSlotKey, width: itemW),
              ],
            ),
          ),
        );
...
class _NextAttackSlot extends StatelessWidget {
  const _NextAttackSlot({required this.keyForFlight, required this.width});
...
class _Pair {
  const _Pair({required this.index, required this.attack, required this.defense});
