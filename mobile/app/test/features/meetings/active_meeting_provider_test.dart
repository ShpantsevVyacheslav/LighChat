...
void main() {
  ...
  group('ActiveMeetingInfo.copyWith', () {
    ...
    test('replaces meetingId only', () {
      const a = ActiveMeetingInfo(meetingId: 'old', meetingName: 'n');
      final b = a.copyWith(meetingId: 'new');
      expect(b.meetingId, 'new');
      expect(b.meetingName, 'n');
    });
  });
}
