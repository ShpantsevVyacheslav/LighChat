...
const DialogContent = React.forwardRef<
  ...
  React.ComponentPropsWithoutRef<typeof DialogPrimitive.Content> & {
    ...
    /** Доп. классы для подложки (например мягче затемнение под стеклянными модалками). */
    overlayClassName?: string
    closeButtonClassName?: string
  }
>(({ className, children, showCloseButton = true, overlayClassName, closeButtonClassName, ...props }, ref) => (
  <DialogPortal>
    <DialogOverlay className={overlayClassName} />
    {/*
      Центрирование через flex + min-h-full (а не fixed + translate): иначе slide-анимация и
