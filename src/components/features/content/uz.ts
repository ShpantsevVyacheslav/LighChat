...
export const uz: FeaturesContent = {
  ...
  mockText: {
    ...
    folderAll: 'Hammasi',
    folderUnread: 'Yangilar',
    folderPersonal: 'Shaxsiy',
    folderGroups: 'Guruhlar',
    folderWork: 'Ish',
    folderFamily: 'Oila',
    folderStudy: 'Oʻqish',
    ...
    stickerTabStickers: 'Stikerlar',
    stickerTabGif: 'GIF',
    stickerOtherUis: 'Alohida oynalar',
    ...
    privacyInvitesTitle: 'Guruhga taklif',
    privacyInviteEveryone: 'Barcha foydalanuvchilar',
    privacyInviteContacts: 'Faqat kontaktlar',
    privacyInviteNone: 'Hech kim',
    privacySearchTitle: 'Sizni topish',
    privacyProfileTitle: 'Boshqalar uchun profil',
