...
import { Pencil, Undo2, LayoutTemplate, Palette } from 'lucide-react';
    ...
    <>
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Выберите иконку Lucide для каждого раздела (включая «Звонки»). Ниже — цвет иконки, толщина
            штриха и фон плитки (в любом режиме нижнего меню). Поиск имён — как на{' '}
            <span className="whitespace-nowrap font-mono text-[10px]">lucide.dev</span>.
          </CardDescription>
        </CardHeader>
        <CardContent className="space-y-2">
          {links.map((link) => {
            ...
            const visual = stylesMap[link.href];
